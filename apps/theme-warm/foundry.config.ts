...
// The counterpart to grand-tour: instead of pinning every token, the theme below sets ONLY
// the three anchors (bg, fg, accent) with warmer shades and lets foundry recompute the
// whole derived ramp, canvas, panel, border, and the text tiers, in the browser. Two or
// three warm values and the entire shell warms up.
