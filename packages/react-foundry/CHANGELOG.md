...
- ef5f4c6: Toolbar controls now have keyboard shortcuts, and a tooltip on each button naming the control and its key. <kbd>S</kbd> and <kbd>P</kbd> toggle the shelf and the controls panel, <kbd>T</kbd> flips the theme, <kbd>A</kbd> toggles the accessibility check.
